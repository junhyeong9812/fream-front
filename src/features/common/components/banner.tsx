...
const HomeBanner: React.FC<BannerSelect> = ({ select }) => {
  const homeBannerItemList: BannerItems[] = [
    {
      img: `${process.env.PUBLIC_URL}/mainImg/banner/banner1.webp`,
      backgroundColor: "#ADACB3",
    },
    {
      img: `${process.env.PUBLIC_URL}/mainImg/banner/banner2.webp`,
      backgroundColor: "#818C8F",
    },
    {
      img: `${process.env.PUBLIC_URL}/mainImg/banner/banner3.webp`,
      backgroundColor: "#9C9B99",
    },
  ];
  const LuxuryBannerItemList: BannerItems[] = [
    {
      img: `${process.env.PUBLIC_URL}/luxuryImg/banner/banner1.webp`,
      backgroundColor: "#BEDAB7",
    },
    {
      img: `${process.env.PUBLIC_URL}/luxuryImg/banner/banner2.webp`,
      backgroundColor: "#D1CBBD",
    },
    {
      img: `${process.env.PUBLIC_URL}/luxuryImg/banner/banner3.webp`,
      backgroundColor: "#BDBDBF",
    },
  ];
  const DiscoveryBannerItemList: BannerItems[] = [
    {
      img: `${process.env.PUBLIC_URL}/discoveryImg/banner/banner1.webp`,
      backgroundColor: "#B5A3E7",
    },
    {
      img: `${process.env.PUBLIC_URL}/discoveryImg/banner/banner2.webp`,
      backgroundColor: "#E1DFD9",
    },
    {
      img: `${process.env.PUBLIC_URL}/discoveryImg/banner/banner3.webp`,
      backgroundColor: "#040404",
    },
  ];

  const [bannerItemList, setBannerItemLIst] =
    useState<BannerItems[]>(homeBannerItemList);
  ...
  return (
    <div
      ...
      style={{ backgroundColor: bannerItemList[currentIndex].backgroundColor }}
    >
      ...
      <div className="home_banner_pagination_content">
        {bannerItemList.map((_, index) => (
          <span
            style={{
              backgroundColor:
                currentIndex === index ? "white" : "rgba(127, 127, 127, 0.5)",
            }}
            onClick={() => {
              setCurrentIndex(index);
              startAutoSlide();
            }}
            className="home_banner_pagination"
          ></span>
        ))}
      </div>
    </div>
